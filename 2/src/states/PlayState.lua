...
function PlayState:update(dt)
    ...
    for k, brick in pairs(self.bricks) do
        for j, ball in pairs (self.ball) do
            ...
            if brick.inPlay and ball:collides(brick) then
                ...
                --check if the bricks have been hit over 3-7 times
                if self.hitCounter >= PlayState:spawnHit() then
                    powerup = math.random(2) == 1 and Powerup(8) or Powerup(9)
                ...
                --remove key if keybrick got unlocked
    ...
    --update logic if the powerup collides with the paddle
    for k, powerup in pairs(self.powerup) do
